...
from config import BOT_NAME, SUPPORT_GROUP, START_VID
...
async def help_cmd(client: Client, message: Message):
    await message.reply_sticker("CAACAgUAAxkBAAITi2LMEVEZGJgUlA8XcIDB7qIzOwUWAAIdBQACFVVAVqj5wwYbJhnVKQQ")
    await message.reply_photo(f"{START_VID}", caption=f"""
    ...
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "😉 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​ ✨", url="https://github.com/THE-Arcane/JinxMusic"
                    )
                ],
                [
                    InlineKeyboardButton(
